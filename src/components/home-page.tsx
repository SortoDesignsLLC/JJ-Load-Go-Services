...
const ServiceAreaMap = dynamic(() => import("@/components/ServiceAreaMap"), {
  ssr: false,
  loading: () => <div className="h-[320px] w-full animate-pulse bg-surface sm:h-[420px] lg:h-[480px]" />,
});
...
const logo = { url: "/images/jj-logo.png" };
const heroImg = "/images/hero.jpg";
const svcJunk = "/images/jj-truck.jpg";
const svcCleanout = "/images/svc-cleanout.jpg";
const svcDebris = "/images/svc-debris.jpg";
const svcDemo = "/images/svc-demo.jpg";
const svcFurniture = "/images/svc-furniture.jpg";
const svcYard = "/images/svc-yard.jpg";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="top" className="relative isolate overflow-hidden">
        <img
          ...
          style={{ filter: "brightness(1.22) contrast(1.04)" }}
